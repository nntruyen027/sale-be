...
@PreAuthorize("hasRole('SUPER_ADMIN') or hasAuthority(T(entier.person.sale.constant.QuyenCons).QUYEN_READ.value()) " +
        "or hasAuthority(T(entier.person.sale.constant.QuyenCons).ROLE_UPDATE.value()) " +
        "or hasAuthority(T(entier.person.sale.constant.QuyenCons).ROLE_CREATE.value())")
